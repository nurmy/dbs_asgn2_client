...
const Country = () => {
    const state = useSelector((state) => {
        return {
            ...
            regging: state.country.regging,
            regged: state.country.regged,
            editing: state.country.editing,
            edited: state.country.edited,
            deleting: state.country.deleting,
        ...
        <div className="wrapper">
            ...
            <div className="d-flex flex-column flex-shrink-0 p-3">
                <div className="d-flex w-100 justify-content-between align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
                    <span className="fs-4">Countries List</span>
                    <button
                        type="button"
                        className="btn btn-primary "
