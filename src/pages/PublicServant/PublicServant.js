...
import {
    fetchPublicServants,
    registerPublicServant,
    editPublicServant,
    removePublicServant,
    resetReg,
    resetEdit,
    resetDelete,
} from '../../features/publicServantSlice'
...
const PublicServant = () => {
    const state = useSelector((state) => {
        return {
            data: state.publicservant.data,
            loaded: state.publicservant.loaded,
            regging: state.publicservant.regging,
            regged: state.publicservant.regged,
            editing: state.publicservant.editing,
            edited: state.publicservant.edited,
            deleting: state.publicservant.deleting,
            deleted: state.publicservant.deleted,
        }
    })
    const dispatch = useDispatch()

    useEffect(() => {
        dispatch(fetchPublicServants())
    }, [])
        ...
        <div className="wrapper">
            ...
            <div className="d-flex flex-column flex-shrink-0 p-3">
                <div className="d-flex w-100 justify-content-between align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
                    <span className="fs-4">Public Servants List</span>
                    <button
                        type="button"
                        className="btn btn-primary "
